...
CREATE TABLE public.comptes (
    ...
    CONSTRAINT comptes_role_check CHECK (((role)::text = ANY ((ARRAY['gestionnaire'::character varying, 'admin'::character varying])::text[])))
);
...
COPY public.anecdote (id_ann, nom, text, date_, tags) FROM stdin;
1	Les bouquinistes des quais	Les bouquinistes des quais de Seine sont une tradition parisienne depuis le 16Šme siŠcle. Ces vendeurs de livres d'occasion installent leurs boŒtes vertes le long des parapets et font partie int‚grante du paysage culturel parisien.	1850-01-01	Histoire, Culture
2	Notre-Dame et les quais	La cath‚drale Notre-Dame de Paris domine majestueusement les quais de Seine depuis plus de 850 ans. Sa construction a commenc‚ en 1163 et elle reste l'un des monuments les plus visit‚s au monde.	1163-01-01	Histoire, Architecture
3	Les p‚niches du quai de Jemmapes	Le canal Saint-Martin et ses quais abritent de nombreuses p‚niches transform‚es en habitations. Ces bateaux-logements offrent un mode de vie unique au cour de Paris.	1970-01-01	Activit‚s, Lifestyle
4	Le pont des Arts et ses cadenas	Le pont des Arts ‚tait c‚lŠbre pour ses milliers de cadenas d'amour accroch‚s par les couples. Bien que retir‚s en 2015 pour des raisons de s‚curit‚, cette tradition reste dans les m‚moires.	2008-01-01	Culture, Romance
5	Les crues de la Seine	Les quais de Seine ont ‚t‚ t‚moins de nombreuses crues historiques, notamment celle de 1910 qui reste la plus importante jamais enregistr‚e. Les marques de niveau d'eau sont encore visibles sur certains ponts.	1910-01-28	Histoire, Nature
6	La voie Georges Pompidou	Cette voie rapide longe la rive droite de la Seine et fut inaugur‚e en 1967. Elle porte le nom du futur pr‚sident de la R‚publique et offre une perspective unique sur les monuments parisiens.	1967-01-01	Histoire, Transport
7	Les guinguettes des bords de Seine	Au 19Šme siŠcle, les guinguettes ‚taient des lieux de divertissement populaires le long des quais. On y dansait, buvait et profitait des plaisirs simples au bord de l'eau.	1860-01-01	Histoire, Culture
8	Les Bouquinistes Centenaires	En 1859, Napol‚on III officialise la pr‚sence des bouquinistes sur les quais de Seine. Ces marchands de livres d'occasion installent leurs boŒtes vertes le long des parapets, cr‚ant une tradition unique au monde. Aujourd'hui, on compte environ 240 bouquinistes r‚partis sur 3 kilomŠtres de quais.	1859-06-15	#histoire #culture #bouquinistes
...
13	Les Bouquinistes Centenaires	En 1859, Napoleon III officialise la presence des bouquinistes sur les quais de Seine. Ces marchands de livres d occasion installent leurs boites vertes le long des parapets, creant une tradition unique au monde. Aujourd hui, on compte environ 240 bouquinistes repartis sur 3 kilometres de quais.	1859-06-15	#histoire #culture #bouquinistes
14	Le Mystere du Vert-Galant	Le square du Vert-Galant, a la pointe de l ile de la Cite, tire son nom du surnom d Henri IV. Une legende raconte qu un tunnel secret relierait ce square au Louvre, permettant au roi de rejoindre discretement ses maitresses. Bien qu aucune preuve n existe, cette histoire fascine encore les Parisiens.	1600-05-14	#legende #royaute #architecture
...
18	Bouquinistes Centenaires	En 1859, Napoleon III officialise la presence des bouquinistes sur les quais de Seine. Ces marchands de livres d occasion installent leurs boites vertes le long des parapets, creant une tradition unique au monde. Aujourd hui, on compte environ 240 bouquinistes repartis sur 3 kilometres de quais.	1859-06-15	#histoire #culture
19	Mystere du Vert-Galant	Le square du Vert-Galant, a la pointe de l ile de la Cite, tire son nom du surnom d Henri IV. Une legende raconte qu un tunnel secret relierait ce square au Louvre, permettant au roi de rejoindre discretement ses maitresses. Bien qu aucune preuve n existe, cette histoire fascine encore les Parisiens.	1600-05-14	#legende #royaute
...
COPY public.articles (id_a, image_miniature, nom, date_creation, text, tags, id_ann, id_u) FROM stdin;
7	guinguettes_seine.jpg	Les Guinguettes d'Antan	2024-03-05 13:45:00	Au 19e siecle, les guinguettes animaient les bords de Seine. Ouvriers et bourgeois s'y retrouvaient pour danser et boire. Ces etablissements populaires, immortalises par les peintres impressionnistes, incarnaient la joie de vivre parisienne.	loisirs, histoire, culture	7	5
10	https://www.splendia.com/wp-content/uploads/2024/01/Quais-de-Seine1-1024x683.jpg	Promenade sur les Quais	2024-03-28 17:30:00	Une promenade sur les quais de Seine traverse l'histoire de Paris. Chaque pierre, chaque parapet raconte une anecdote. Du Pont-Neuf a l'ile Saint-Louis, ces chemins pietons offrent une evasion unique au coeur de la capitale.	tourisme, patrimoine, decouverte	8	3
8	https://www.pariszigzag.fr/wp-content/uploads/2020/06/shutterstock_495019168-e1625217963918.jpg	Le Secret du Vert-Galant	2024-03-12 15:20:00	Le square du Vert-Galant cache-t-il un tunnel secret? La legende raconte qu'Henri IV rejoignait discretement ses favorites par un passage souterrain. Cette histoire, vraie ou fausse, ajoute au mystere de ce lieu emblematique.	legende, royaute, mystere	9	2
...
4	contact@tayoken.xyz	$2y$10$zhLd4sturCuOT3IUWksswuOSzqbRlnMMEFxH0nOuB6TTzO9iCV.4i	tayoken	admin	2025-06-08 16:39:15.301843	2025-06-08 17:35:52.335888
\.
